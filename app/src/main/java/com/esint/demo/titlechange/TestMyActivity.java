...
public class TestMyActivity extends AppCompatActivity implements GradationScrollView.ScrollViewListener{
...
//        StatusBarUtil.setImgTransparent(this);
    ...
    private void initListeners() {
        ...
        scrollView.setScrollViewListener(TestMyActivity.this);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(TestMyActivity.this, Cheeses.NAMES[position], Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initData() {
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(TestMyActivity.this, android.R.layout.simple_list_item_1, Cheeses.NAMES);
